        ...
        public bool SupplierPaymentPostAccounts(string ConsolidatedVcNumber, string Loc_Code, string Doc_Year, string Doc_Date, decimal Cheque_Amount, string Cheque_Date, OracleConnection con, OracleTransaction Tr)
        {
            ...
            try
            {
                ...
                while (rs1.Read())
                {
                    ...
                    else PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, SupplierCode, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, 0, (Dr*-1), 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Dr, Dr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                    ...
                    else PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, BAnk_Code, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, (Cr*-1),0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Cr, Cr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
        ...
        public bool SupplierPaymentPostAccounts_recons_spvpost(string ConsolidatedVcNumber, string Loc_Code, string Doc_Year, string Doc_Date, decimal Cheque_Amount, string Cheque_Date, OracleConnection con, OracleTransaction Tr)
        {
            ...
            try
            {
                ...
                while (rs1.Read())
                {
                    ...
                    else PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, SupplierCode, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, 0, (Cr*-1), 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Cr, Cr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                    ...
                    else PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, BAnk_Code, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, (Dr*-1) ,0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Dr, Dr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "DR", "", "", "", "", "", Doc_No, "SPV");
                    //// Contract
                    //cmd = con.CreateCommand();
                    //cmd.Transaction = Tr;
                    //cmd.CommandText = "select * from ACCT_SUPPAYcontract where doc_no='" + Doc_No + "'";
