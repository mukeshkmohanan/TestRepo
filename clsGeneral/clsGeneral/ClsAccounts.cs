...
namespace MALL
{
    public class ClsAccounts
    {
        ...
        public bool SupplierPaymentPostAccounts(string ConsolidatedVcNumber, string Loc_Code, string Doc_Year, string Doc_Date, decimal Cheque_Amount, string Cheque_Date, OracleConnection con, OracleTransaction Tr)
        {
            ...
            try
            {
                ...
                while (rs1.Read())
                {
                    ...
                    else throw new Exception("Negative Amount Not Allowed!!!");//PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, SupplierCode, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, 0, (Dr*-1), 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Dr, Dr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                    ...
                    else throw new Exception("Negative Amount Not Allowed!!!");//PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, BAnk_Code, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, (Cr*-1),0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Cr, Cr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                    ...
                    while (rs.Read())
                    {
                        ...
                        if (DataConnector.IsNumericPositive(rs["PAID"].ToString()))
                            ...
                            PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, RebAc, rs["REB_NAME"].ToString() + " Paid To " + SupplierName, Defaults.Def_Currency, 1, decimal.Parse(rs["PAID"].ToString()) * -1, 0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", decimal.Parse(rs["PAID"].ToString()), decimal.Parse(rs["PAID"].ToString()), ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");

                        if (DataConnector.IsNumericPositive(rs["TAXAMOUNT"].ToString()))
                        {
                            PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, Defaults.Def_Acct_Vat_Output, rs["REB_NAME"].ToString() + " VAT ALLOWED ON OUTPUT " + " Received From " + SupplierName, Defaults.Def_Currency, 1, 0, decimal.Parse(rs["TAXAMOUNT"].ToString()), 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", decimal.Parse(rs["TAXAMOUNT"].ToString()), decimal.Parse(rs["TAXAMOUNT"].ToString()), ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                        }
                        else
                        {
                            if (Defaults.Def_Taxable_Loc)
                            {
                                PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, Defaults.Def_Acct_Vat_Output, rs["REB_NAME"].ToString() + " VAT ALLOWED ON OUTPUT " + " Paid To " + SupplierName, Defaults.Def_Currency, 1, decimal.Parse(rs["TAXAMOUNT"].ToString()) * -1, 0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", decimal.Parse(rs["TAXAMOUNT"].ToString()), decimal.Parse(rs["TAXAMOUNT"].ToString()), ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                            }
                        }
                    }
                    rs.Close();
        ...
        public bool SupplierPaymentPostAccounts_recons_spvpost(string ConsolidatedVcNumber, string Loc_Code, string Doc_Year, string Doc_Date, decimal Cheque_Amount, string Cheque_Date, OracleConnection con, OracleTransaction Tr)
        {
            OracleCommand cmd = null;
            OracleCommand cmd1 = null;
            OracleDataReader rs = null;
            ...
            try
            {
                ...
                while (rs1.Read())
                {
                    ...
                    decimal Cr = decimal.Parse(rs1["CHEQUE_AMOUNT"].ToString());
                    decimal Dr = decimal.Parse(rs1["NET_INVOICE"].ToString());
                    Dr = Cr;//20221220 dis with abhi
                    // Post Main Payment
                    
                    if (Cr >= 0)
                        PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, SupplierCode, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, Cr, 0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Cr, Cr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");

                    else
                        //throw new Exception("Negative Amount Not Allowed!!!");
                        PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, SupplierCode, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, 0, (Cr * -1), 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Cr, Cr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");

                   
                    if (Dr >= 0)
                        PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, BAnk_Code, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, 0, Dr, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Dr, Dr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "DR", "", "", "", "", "", Doc_No, "SPV");

                    else
                        //throw new Exception("Negative Amount Not Allowed!!!");
                        PostEntry(Loc_Code1, Doc_Year1, "BPV", AcctDoc, (++j), Doc_Date, BAnk_Code, "Cheque Issued to " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, (Dr * -1), 0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", Dr, Dr, ChqNo, Cheque_Date, Cheque_Amount, "", "", "", true, true, "DR", "", "", "", "", "", Doc_No, "SPV");
        ...
        public bool SupplierPaymentPostAccounts_spvpost(string SPV_NO, OracleConnection con, OracleTransaction Tr)
        {
            OracleCommand cmd = null;
            OracleCommand cmd1 = null;
            OracleDataReader rs = null;
            if (ClsGeneral.Exists("Acct_transactions", "org_doc_no", "ORG_doc_no='" + SPV_NO + "'", con, Tr))
            {
                DataConnector.Message("Already Posted");
                return false;
            }
            try
            {
                string Sql = "Select * from acct_supplierpayment where doc_no='" + SPV_NO + "' Order By LOC_CODE,DOC_NO";  //string Sql = "Select * from acct_supplierpayment where CON_VCH_no='" + ConsolidatedVcNumber + "'";
                OracleDataReader rs1 = ClsGeneral.GetValue(con, Tr, Sql);
                string ChqNo = "";
                string AcctDoc = "";
                //rs1 = cmd1.ExecuteReader();
                bool TranOk = false;
                ...
                //  AcctDoc = ClsGeneral.GetDocSerial_Acct(Defaults.Def_Main_Loc, "BPV", Defaults.Def_YEAR, con, Tr);
                //  ClsGeneral.UpdateDocSerial_Acct("BPV", Defaults.Def_YEAR, con , Tr);

                AcctDoc = ClsGeneral.GetValue("SELECT DOC_NO FROM ACCT_SUPPAYCONTRACTINVOICE WHERE VCH_DOC_NO = '" + SPV_NO + "'", con, Tr);
                if (AcctDoc.Length <= 0)
                {
                    DataConnector.Message("Supplier Invoice Not Found..!!");
                    return false;
                }
                while (rs1.Read())
                {
                    ...
                    TranOk = true;
                    string Doc_Date = DateTime.Today.ToString("dd/MMM/yyyy");
                    Doc_No = rs1["Doc_no"].ToString();
                    if (Doc_No == "") return false;
                    string Loc_Code1 = rs1["LOC_CODE"].ToString();
                    string Doc_Date1 = DateTime.Parse(rs1["Doc_DATE"].ToString()).ToString("dd/MMM/yyyy");
                    ...
                    while (rs.Read())
                    {
                        ...
                        if (decimal.Parse(rs["PAID"].ToString()) >= 0)
                            PostEntry(Loc_Code1, Doc_Year1, "SCI", AcctDoc, (++j), Doc_Date, RebAc, rs["REB_NAME"].ToString() + " Received From " + SupplierName, Defaults.Def_Currency, 1, 0, decimal.Parse(rs["PAID"].ToString()), 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", decimal.Parse(rs["PAID"].ToString()), decimal.Parse(rs["PAID"].ToString()), null, null, 0, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                        else
                            PostEntry(Loc_Code1, Doc_Year1, "SCI", AcctDoc, (++j), Doc_Date, RebAc, rs["REB_NAME"].ToString() + " Paid To      " + SupplierName, Defaults.Def_Currency, 1, decimal.Parse(rs["PAID"].ToString()) * -1, 0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", decimal.Parse(rs["PAID"].ToString()), decimal.Parse(rs["PAID"].ToString()), null, null, 0, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");

                        NetCr += decimal.Parse(rs["PAID"].ToString());
                        if (DataConnector.IsNumericPositive(rs["TAXAMOUNT"].ToString()))
                        {
                            PostEntry(Loc_Code1, Doc_Year1, "SCI", AcctDoc, (++j), Doc_Date, Defaults.Def_Acct_Vat_Output, rs["REB_NAME"].ToString() + " VAT ALLOWED ON OUTPUT " + " Received From " + SupplierName, Defaults.Def_Currency, 1, 0, decimal.Parse(rs["TAXAMOUNT"].ToString()), 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", decimal.Parse(rs["TAXAMOUNT"].ToString()), decimal.Parse(rs["TAXAMOUNT"].ToString()), null, null, 0, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                        }
                        else if (DataConnector.IsNumeric(rs["TAXAMOUNT"].ToString()) && decimal.Parse(rs["TAXAMOUNT"].ToString()) < 0)
                        {
                            if (Defaults.Def_Taxable_Loc)
                            {
                                PostEntry(Loc_Code1, Doc_Year1, "SCI", AcctDoc, (++j), Doc_Date, Defaults.Def_Acct_Vat_Output, rs["REB_NAME"].ToString() + " VAT ALLOWED ON OUTPUT " + " Paid To       " + SupplierName, Defaults.Def_Currency, 1, decimal.Parse(rs["TAXAMOUNT"].ToString()) * -1, 0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", decimal.Parse(rs["TAXAMOUNT"].ToString()), decimal.Parse(rs["TAXAMOUNT"].ToString()), null, null, 0, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                            }
                        }

                        NetCr += decimal.Parse(rs["TAXAMOUNT"].ToString());
                    }
                    rs.Close();
                    cmd.Dispose();
                    ...
                    while (rs.Read())
                    {
                        PostEntry(Loc_Code1, Doc_Year1, "SCI", AcctDoc, (++j), Doc_Date, rs["ACCT_CODE"].ToString(), rs["NARRATION"].ToString(), Defaults.Def_Currency, 1, decimal.Parse(rs["Dr"].ToString()), decimal.Parse(rs["CR"].ToString()), 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", decimal.Parse(rs["CR"].ToString()), decimal.Parse(rs["CR"].ToString()), null, null, 0, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                        NetDr += decimal.Parse(rs["Dr"].ToString());
                        NetCr += decimal.Parse(rs["CR"].ToString());
                    }
                    rs.Close();
                    cmd.Dispose();
                    if ((NetDr = (NetDr - NetCr)) < 0)
                        PostEntry(Loc_Code1, Doc_Year1, "SCI", AcctDoc, (++j), Doc_Date, SupplierCode, "Contract Deduction From " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, NetDr * -1, 0, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", NetDr * -1, NetDr * -1, null, null, 0, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                    else
                        PostEntry(Loc_Code1, Doc_Year1, "SCI", AcctDoc, (++j), Doc_Date, SupplierCode, "Contract Deduction From " + SupplierName + " " + Narration, Defaults.Def_Currency, 1, 0, NetDr, 0, 0, false, "", "", "", Doc_No, Loc_Code1, "SPV", "", NetDr, NetDr, null, null, 0, "", "", "", true, true, "CR", "", "", "", "", "", Doc_No, "SPV");
                }
                rs1.Close();
                //cmd1.Dispose();
            }
