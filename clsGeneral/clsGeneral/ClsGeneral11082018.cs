    ...
    */
    ...
    public static class Defaults
    {
        ...
        public static bool Set_Default_Values(string stLocation, OracleConnection oCon)
        {
            ...
            try
            {
                ...
                rs = oCmd.ExecuteReader();
                Sql = "LOC_CODE,LOC_NAME,BRANCH_ACCT_CODE,ACTIVE,UPDATED_LOC,LOC_TYPE,GROUP_LOC," +
                      "MANAGEMENT_LOC,ADDRESS,STREET,FAX,POBOX,TEL,INDIVIDUAL_LOC,CURRENT_LOC,CENTRAL_LOCATION";
                if (rs.HasRows)
                {
                    if (rs.Read())
                    {
                    ...
                    while (rs.Read())
                    {
                        ...
                        switch (rs["SETTING"].ToString())
                        {
                            ...
                            case "HEADER_IMAGE_PRINT": // Warehouse management system active
                                ////if (rs["VALUE1"].ToString().Equals("Y")) Defaults.G_HEADER_IMAGE_PRINT = true;
                                ////if (rs["VALUE1"].ToString().Equals("N")) Defaults.G_HEADER_IMAGE_PRINT = false;
                                break;
                            case "FOOTER_IMAGE_PRINT": // Warehouse management system active

                                ////if (rs["VALUE1"].ToString().Equals("Y")) Defaults.G_FOOTER_IMAGE_PRINT = true;
                                ////if (rs["VALUE1"].ToString().Equals("N")) Defaults.G_FOOTER_IMAGE_PRINT = false;
                                break;
                            case "SUPERVISOR_SCAN_4GIFTVCH": // Warehouse management system active

                                ////if (rs["VALUE1"].ToString().Equals("Y")) Defaults.G_SUPERVISOR_SCAN_4GIFTVCH = true;
                                ////if (rs["VALUE1"].ToString().Equals("N")) Defaults.G_SUPERVISOR_SCAN_4GIFTVCH = false;
                                break;
                        }
                    }
                }
    ...
    public class DataConnector
    {
        ...
        public static bool get_blockedStatus(string doctype, string loccode, string packing, string partnumber, OracleConnection oraConn)
        {
            ...
            try
            {
                string sql = " select * from INVT_PRODUCT_BLOCKING where loc_code='" + loccode + "' and (BLOCK_MODE='" + doctype + "' OR BLOCK_MODE='ALL') and PART_NUMBER_SUP='" + partnumber + "' order by BLOCK_MODE asc,ALL_PACKING_BLOCK asc,PACKING asc";
        ...
        */
        ...
        public enum TransferTypes
        {
            ...
            PRICE_BATCH, TRANREQ, TENPRC, GPO, REM
        }
        ...
        public bool SendEmail(string Address, string FromAddr, string Subject, string BodyText, string Attachments, string pwd)
        {
